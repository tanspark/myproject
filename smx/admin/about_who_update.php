...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_ABOUT_WHO', $data);

    header("Location: about_who.php");
    if($state) {
        echo "更新成功";
    } else {
        echo "更新失败";
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="about_who_update.php" method="post">
