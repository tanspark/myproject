...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_AWARD_INSTI', $data);

    if($state != 0) {
        echo "存储成功";
        header("Location: award_insti.php");
    } else {
        echo "存储失败";
    }
}
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="award_insti_update.php" method="post">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    <option value = "1" <?php if($res[0]['t_type'] == 1) {?>selected = "selected" <?php } ?>>成果竞赛--专业陪审团</option>
                                    <option value = "2" <?php if($res[0]['t_type'] == 2) {?>selected = "selected" <?php } ?>>成果竞赛--大众评审团</option>
                                    <option value = "3" <?php if($res[0]['t_type'] == 1) {?>selected = "selected" <?php } ?>>创意大赛--专业陪审团</option>
                                    <option value = "4" <?php if($res[0]['t_type'] == 2) {?>selected = "selected" <?php } ?>>创意大赛--大众评审团</option>
                                </select>
                            </div>
                            <br>
