...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_AWARD_OTHER', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="award_other_update.php" method="post">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    <option value = "1" <?php if($res[0]['t_type'] == 1) {?>selected = "selected" <?php } ?>>专项奖</option>
                                    <option value = "2" <?php if($res[0]['t_type'] == 2) {?>selected = "selected" <?php } ?>>十佳创新成果奖</option>
                                    <option value = "3" <?php if($res[0]['t_type'] == 3) {?>selected = "selected" <?php } ?>>青年社会责任奖</option>
                                    <option value = "4" <?php if($res[0]['t_type'] == 4) {?>selected = "selected" <?php } ?>>分赛区奖项</option>
                                </select>
                            </div>
                            <br />
