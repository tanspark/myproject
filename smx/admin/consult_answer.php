            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="consult_answer_add.php" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新增
                        </a>
                    </div>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <td class="align-center">
                                <a href="consult_answer_update.php?id=<?php echo $res[$i]['t_id']; ?>" class="name">
                            ...
                            <td class="align-center">
                                <a href="consult_answer_update.php?id=<?php echo $res[$i]['t_id']; ?>">编辑</a>
                            </td>
                            <td class="align-center">
                                <a href="consult_answer_delete.php?id=<?php echo $res[$i]['t_id']; ?>">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        <!-- row -->
                ...
                <div class="pagination pull-right">
                    <ul>
                        ...
                        ?>
                            <li><a <?php if($pageNo==$i){ ?>class="active"<?php } ?> href="consult_answer.php?pageNo=<?php echo $i;?>">
                                    <?php echo $i; ?></a></li>
                        <?php
                        }?>
                        <li><a href="#">&#8250;</a></li>
