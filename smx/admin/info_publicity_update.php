...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_PUBLICITY', $data);
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <?php echo htmlspecialchars($res[0]['t_content']); ?>
=================
                        <br>
                        <?php echo $res[0]['t_content']; ?>
                        <form action="info_publicity_update.php" method="post" enctype="multipart/form-data">
