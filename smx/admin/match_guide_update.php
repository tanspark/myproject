...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_GUIDE', $data);

    if($state != 0) {
        echo "存储成功";
        header("Location: match_guide.php");
    } else {
        echo "存储失败";
    }
}
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="match_guide_update.php" method="post" enctype="multipart/form-data">
