...
$pageSize = 10;
$total = MySqlOperate::getInstance()->totals('T_INSTITUTION');
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="match_insti_add.php" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新增
                        </a>
                    </div>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <td class="align-center">
                                <a href="match_insti_update.php?id=<?php echo $res[$i]['t_id']; ?>" class="name">
                            ...
                            <td class="align-left">
                                ...
                                if($res[$i]['t_type'] == 1) {
                                    ...
                                    echo "支持单位";
                                } else if($res[$i]['t_type'] == 5) {
                                    echo "组委会";
                                } else if($res[$i]['t_type'] == 6) {
                                    echo "合作媒体";
                                } else if($res[$i]['t_type'] == 7) {
                                    echo "志愿者";
                                } ?>
                            </td>
                            <td class="align-center">
                            ...
                            <td class="align-center">
                                <a href="match_insti_update.php?id=<?php echo $res[$i]['t_id']; ?>">编辑</a>
                            </td>
                            <td class="align-center">
                                <a href="match_insti_delete.php?id=<?php echo $res[$i]['t_id']; ?>">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        <!-- row -->
                ...
                <div class="pagination pull-right">
                    <ul>
                        ...
                        ?>
                            <li><a <?php if($pageNo==$i){ ?>class="active"<?php } ?> href="match_insti.php?pageNo=<?php echo $i;?>">
                                    <?php echo $i; ?></a></li>
                        <?php
                        }?>
                        <li><a href="#">&#8250;</a></li>
