...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_EXPERT', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="online_expert_update.php" method="post" enctype="multipart/form-data">
                            <input name="id" value="<?php echo $res[0]['t_id']; ?>" type="hidden">

                            <div class="field-box">
                                专家简介：&nbsp;&nbsp;&nbsp;
                                <input class="span8" type="text" name="desc"  value="<?php echo $res[0]['t_name']?>"/>
                            </div>
                            <br />

                            <div class="field-box">
                                专家简介：&nbsp;&nbsp;&nbsp;
                                <input class="span8" type="text" name="desc"  value="<?php echo $res[0]['t_desc']?>"/>
                            </div>
                            <br />
