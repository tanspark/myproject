...
<div class="col s12 m4 l4">
    <div class="top-post mb-10">
        <div class="Comments-post" style="min-height: 310px;">

            <span class="title-left" style="font-size: 16px;">Notice</span>

            <span class="title-right">
                <a href="info_notice.php">more+</a>
            </span>
            <hr>
                    ...
                    <div class="col s12">
                        <span class="black-text">
                            <a href="info_notice_detail.php?id=<?php echo $res_notice[$i]['t_id']; ?>">
                                    <?php echo substr_text($res_notice[$i]['t_title'], 0,40); ?>
                            </a>
                        </span>
...
<div class="col s12 m4 l4">
    <div class="top-post w100dt mb-10">
        <div class="Comments-post" style="min-height: 310px;">
            <span class="title-left" style="font-size: 16px;">Trend</span>

            <span class="title-right">
                <a href="info_trends.php">more+</a>
            </span>
            <hr>
                    ...
                    <div class="col s12">
                            <span class="black-text">
                                <a href="info_trends_detail.php?id=<?php echo $res_trends[$i]['t_id']; ?>">
                                    <?php echo substr_text($res_trends[$i]['t_title'],0,40); ?>
                                </a>
                            </span>
...
<div class="col s12 m4 l4">
    <div class="top-post w100dt mb-10">
        <div class="Comments-post" style="min-height: 310px;">
            <span class="title-left" style="font-size: 16px;">List publicity</span>
            <span class="title-right">
                <a href="info_publicity.php">more+</a>
            </span>
            <hr>
                    ...
                    <div class="col s12">
                        <span class="black-text">
                            <a href="info_publicity_detail.php?id=<?php echo $res_publicity[$i]['t_id']; ?>">
                                <?php echo substr_text($res_publicity[$i]['t_title'], 0,40); ?>
                            </a>
                        </span>
