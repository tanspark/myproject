        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="award_other.php" target="mainFrame">其他奖项</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="info_trends.php" target="mainFrame">大赛动态</a></li>
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="online_team.php" target="mainFrame">参赛团队</a></li>
                    <li><a href="online_stories.php" target="mainFrame">参赛作品</a></li>
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="wonder_m_segment.php" target="mainFrame">大赛时段</a></li>
                    <li><a href="wonder_m_district.php" target="mainFrame">大赛地区</a></li>
                    <li><a href="wonder_m_theme.php" target="mainFrame">大赛主题</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    <li><a href="about_who.php" target="mainFrame">我是谁</a></li>
