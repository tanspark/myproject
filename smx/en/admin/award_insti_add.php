...
if(!empty($_POST['title']) && !empty($_POST['type']) && $_POST['content']) {
    ...
    $state =  MySqlOperate::getInstance()->insert('T_AWARD_INSTI', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="award_insti_add.php" method="post">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    <option value="1">成果竞赛--专业陪审团</option>
                                    <option value="2">成果竞赛--大众评审团</option>
                                    <option value="3">创意大赛--专业陪审团</option>
                                    <option value="4">创意大赛--大众评审团</option>
                                </select>
                            </div>
                            <br>
