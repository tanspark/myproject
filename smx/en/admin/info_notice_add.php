...
if(!empty($_POST['title']) && !empty($_POST['content'])) {
    ...
    $state =  MySqlOperate::getInstance()->insert('T_NOTICE', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="info_notice_add.php" method="post" enctype="multipart/form-data">
                            <div class="field-box">
                                公告标题：&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="field-box">
                                ...
                                <input type="button" name="btnCreateText" value="新增图片" onclick="Dom();" />
                                <hr>
                                <div id="Show"></div>
                            </div>
