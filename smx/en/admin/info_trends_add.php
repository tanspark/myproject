...
if(!empty($_POST['title']) && $_POST['content']) {
    ...
    $state =  MySqlOperate::getInstance()->insert('T_TRENDS', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="info_trends_add.php" method="post" enctype="multipart/form-data">
                            <div class="field-box">
                                动态标题：&nbsp;&nbsp;&nbsp;
                                <input id="title" class="span8" type="text" name="title" />
                            </div>
                            <br>

                            动态简介：
                            <textarea id="desc" name="desc" style="width:1000px; height:50px; "></textarea>
                            <br>
