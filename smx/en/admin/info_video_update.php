...
if(!empty($_GET['id'])) {
    $res = MySqlOperate::getInstance()->field('t_id,t_title,t_content,t_filename,t_filepath,t_video_name,t_video_path')
        ->where('t_id='.$_GET['id'])
        ->select('t_video');
}
...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('t_video', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="info_video_update.php" method="post" enctype="multipart/form-data">
