...
$pageSize = 10;
$total = MySqlOperate::getInstance()->totals('T_MATCH_INFO');
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="match_intro_add.php" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新增
                        </a>
                    </div>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <td class="align-center">
                                <a href="match_intro_update.php?id=<?php echo $res[$i]['t_id']; ?>" class="name">
                            ...
                            <td class="align-center">
                                <?php if($res[$i]['t_selected'] == 1) { echo "选中";} else { echo "未选中";}?>
                            </td>
                            <td class="align-center">
                                <?php echo $res[$i]['t_time'];?>
                            </td>
                            <td class="align-center">
                                <a href="match_intro_update.php?id=<?php echo $res[$i]['t_id']; ?>">编辑</a>
                            </td>
                            <td class="align-center">
                                <a href="match_intro_delete.php?id=<?php echo $res[$i]['t_id']; ?>">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        <!-- row -->
                ...
                <div class="pagination pull-right">
                    <ul>
                        ...
                        ?>
                            <li><a <?php if($pageNo==$i){ ?>class="active"<?php } ?> href="match_intro.php?pageNo=<?php echo $i;?>">
                                    <?php echo $i; ?></a></li>
                        <?php
                        }?>
                        <li><a href="#">&#8250;</a></li>
