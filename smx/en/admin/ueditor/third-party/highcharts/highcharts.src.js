 ...
 *
 * License: www.highcharts.com_kp/license
 */
...
function error(code, stop) {
	var msg = 'Highcharts error #' + code + ': www.highcharts.com_kp/errors/' + code;
	if (stop) {
		throw msg;
	} else if (win.console) {
		console.log(msg);
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: 'http://code.highcharts.com_kp/3.0.6/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.highcharts.com_kp/3.0.6/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
	...
	credits: {
		enabled: true,
		text: 'Highcharts.com_kp',
		href: 'http://www.highcharts.com_kp',
		position: {
			align: 'right',
			x: -10,
			verticalAlign: 'bottom',
...
var VMLRendererExtension = { // inherit SVGRenderer
	...
	init: function (container, width, height) {
		...
		if (!doc.namespaces.hcv) {
			...
			doc.namespaces.add('hcv', 'urn:schemas-microsoft-com_kp:vml');
	...
	prepVML: function (markup) {
		...
		if (isIE8) { // add xmlns and style inline
			markup = markup.replace('/>', ' xmlns="urn:schemas-microsoft-com_kp:vml" />');
