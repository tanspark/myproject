                ...
                <div class="col s12 m4 l12">
                    ...
                    <div class="featured-posts w100dt mb-30">
                        ...
                        <div class="sidebar-posts">
                                ...
                                <ul class="option-list " id="region">
                                    ...
                                    if(!empty($res_distict))
                                        ...
                                        <li id="repYear_liYear_0" title="全部"
                                            ...
                                            <a id="repYear_lbtnYear_0" href="wonder_current.php?district=<?php echo $res_distict[$i]['t_id'];
                                            if(!empty($_GET['segment'])) {
                            ...
                            <div class="option-item">
                                ...
                                <ul class="option-list " id="time">
                                    ...
                                    if(!empty($res_theme))
                                        ...
                                        <a id="repYear_lbtnYear_0" href="wonder_current.php?theme=<?php echo $res_theme[$i]['t_id'];
                                            if(!empty($_GET['segment'])) {
                                                echo '&segment='.$_GET['segment'];
                                            }
                                            if(!empty($_GET['district'])) {
                            ...
                            <div class="option-item">
                                <span class="tt">排序：</span>
                                <ul class="option-list order-list  ">
                                    <li class="cur" id="time">
                                        <a id="lbtnTime" href="#"><i class="icons-time icons-01"></i> 点击量</a></li>
                                    <li id="play">
                                        <a id="lbtnPlay" href="#"><i class="icons-time icons-02"></i> 编辑推荐</a></li>
                                    ...
                                    if(!empty($res))
                                        ...
                                        <li class="mb-10">
                                            <div class="video-image">
                                                <a href="wonder_current_detail.php?id=<?php echo $res[$i]['t_id']; ?>">
                                                    <img src="<?php echo $res[$i]['t_filepath'];?>"
                                                         alt="<?php echo $res[$i]['t_title'];?>"
                                                         style="width: 300px; height: 160px;">
                                                </a>
                                            </div>
                                            <div class="news-handle tr center">
                                                <div class="name center" style="background-color: rgba(255,255,255,0.1);">
                                                    <p><a href="wonder_current_detail.php?id=<?php echo $res[$i]['t_id'];?>">
                    ...
                    <ul class="pagination w100dt">
                        <?php if($pageNo > 1) { ?>
                            <li class="waves-effect"><a href="wonder_current.php?pageNo=<?php echo $pageNo-1;?>"><i class="icofont icofont-simple-left"></i></a></li>
                        <?php } ?>
                        <?php for( $i=0; $i < $pageTotal; $i++) { ?>
                            <?php if($pageNo < $pageTotal) { ?>
                                <li class="waves-effect">
                                    <a href="wonder_current.php?pageNo=<?php echo $i;
                                    if(!empty($_GET['segment'])) {
                                        echo '&segment='.$_GET['segment'];
                                    }
                                    if(!empty($_GET['district'])) {
                        ...
                        <?php }?>
                        <?php if($pageNo < $pageTotal) { ?>
                            <li class="waves-effect"><a href="wonder_current.php?pageNo=<?php echo $pageNo+1;?>"><i class="icofont icofont-simple-right"></i></a></li>
                        <?php } ?>
                    </ul>
                </div>
                <!-- colm4 -->
