...
if(!empty($_POST['title']) && $_POST['content']) {
    ...
    $state =  MySqlOperate::getInstance()->insert('T_CONTACT', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="contact_list_add.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    ...
                                    <option value="<?php echo $res_type[$i]['t_id'] ?>"><?php echo $res_type[$i]['t_title']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <br>
