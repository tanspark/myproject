...
$pageSize = 10;
$total = MySqlOperate::getInstance()->totals('T_CONTACT_TYPE');
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="contact_type_add.php" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新增
                        </a>
                    </div>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <td class="align-left">
                                <a href="contact_type_update.php?id=<?php echo $res[$i]['t_id']; ?>" class="name"><?php echo $res[$i]['t_title'];?> </a>
                            </td>
                            <td class="align-center">
                                <a href="contact_type_update.php?id=<?php echo $res[$i]['t_id']; ?>">编辑</a>
                            </td>
                            <td class="align-center">
                                <a href="contact_type_delete.php?id=<?php echo $res[$i]['t_id']; ?>">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        <!-- row -->
                ...
                <div class="pagination pull-right">
                    <ul>
                        ...
                        ?>
                            <li><a <?php if($pageNo==$i){ ?>class="active"<?php } ?> href="contact_type.php?pageNo=<?php echo $i;?>">
                                    <?php echo $i; ?></a></li>
                        <?php
                        }?>
                        <li><a href="#">&#8250;</a></li>
