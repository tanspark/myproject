...
if(!empty($_POST['title']) && !empty($_POST['type']) && $_POST['content']) {
    ...
    $state =  MySqlOperate::getInstance()->insert('T_FOUND_IDEA', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="found_idea_add.php" method="post">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    <option value="1">愿景</option>
                                    <option value="2">使命</option>
                                    <option value="3">价值观</option>
                                </select>
                            </div>
                            <br>
