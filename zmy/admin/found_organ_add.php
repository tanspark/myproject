...
if(!empty($_POST['title']) && !empty($_POST['type']) && $_POST['content']) {
    ...
    $state =  MySqlOperate::getInstance()->insert('T_FOUND_ORGAN', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="found_organ_add.php" method="post">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    <option value="1">理事会</option>
                                    <option value="2">监事会</option>
                                    <option value="3">秘书处</option>
                                </select>
                            </div>
                            <br>
