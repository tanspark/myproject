...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_FOUND_WORD', $data);

    header("Location: found_word.php");
    if($state) {
        echo "更新成功";
    } else {
        echo "更新失败";
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="found_word_update.php" method="post">
