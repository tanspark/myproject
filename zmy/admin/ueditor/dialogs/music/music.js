...
(function () {
    ...
    Music.prototype = {
        total:70,
        pageSize:10,
        dataUrl:"http://tingapi.ting.baidu.com_kp/v1/restserver/ting?method=baidu.ting.search.common",
        playerUrl:"http://box.baidu.com_kp/widget/flash/bdspacesong.swf",
        ...
        _buildMusicHtml:function (playerUrl) {
            var html = '<embed class="BDE_try_Music" allowfullscreen="false" pluginspage="http://www.macromedia.com_kp/go/getflashplayer"';
            html += ' src="' + playerUrl + '"';
