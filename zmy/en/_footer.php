    ...
    <div class="container">
        <div class="row">
            <div class="span12" style="text-align: center; margin-top: 10px;">
                ...
                <a href="found_about.php">Foundation Overview</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;
                <a href="welfare_project_intro.php">Charitable Projects</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;
                <a href="news_list.php">News</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;
                <a href="info_annual.php">Information Disclosure</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;
                <a href="donate_person.php">Love Donate</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;
