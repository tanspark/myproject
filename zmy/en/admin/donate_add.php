...
if(!empty($_POST['title']) && $_POST['content']) {
    ...
    $state =  MySqlOperate::getInstance()->insert('T_DONATE', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="donate_add.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    <option value="1">捐赠人</option>
                                    <option value="2">爱心企业</option>
                                </select>
                            </div>
                            <br>
                            <div class="field-box">
