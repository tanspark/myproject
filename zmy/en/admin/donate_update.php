...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_DONATE', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="donate_update.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="field-box">
                                ...
                                <select name="type" style="height: 30px;">
                                    <option value="1" <?php if($res[0]['t_type'] == 1) {?>selected = "selected" <?php } ?>>捐赠人</option>
                                    <option value="2" <?php if($res[0]['t_type'] == 2) {?>selected = "selected" <?php } ?>>爱心企业</option>
                                </select>
                            </div>
                            <br />
