...
if(!empty($_GET['id'])) {
    $res = MySqlOperate::getInstance()->field('t_id,t_title,t_year,t_content')
        ->where('t_id='.$_GET['id'])
...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_NEWS_HONOUR', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="news_honour_update.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="field-box">
                                时间：&nbsp;&nbsp;&nbsp;
                                <input class="span8" type="text" name="year" value="<?php echo $res[0]['t_year']?>" />
                            </div>
                            <br />
