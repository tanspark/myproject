...
if(!empty($_GET['id'])) {
    $res = MySqlOperate::getInstance()->field('t_id,t_title,t_file_path,t_link')
        ->where('t_id='.$_GET['id'])
...
if(!empty($_POST['id'])) {
    ...
    $state =  MySqlOperate::getInstance()->where(array('t_id' => $_POST['id']))->update('T_SPECIAL_PROJECT', $data);
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form action="special_project_update.php" method="post" enctype="multipart/form-data">
