...
// 
//      http:// tangram.baidu.com_kp/license.html
// 
...
baidu.swf.createHTML = function (options) {
    ...
    options['codebase'] = 'http://fpdownload.macromedia.com_kp/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0';
    ...
    options['pluginspage'] = 'http://www.macromedia.com_kp/go/getflashplayer';
    str.push('<embed');
    var salign;
    for (k in options) {
        item = options[k];
