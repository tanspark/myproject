...
<section id="container">
    <div class="container">
        ...
        <div class="row">
            ...
            <section class="span10 portfolio filtrable clearfix">
                ...
                <?php for($i=0; $i<count($res); $i++) { ?>
                    <article class="span2" style="width: 200px; height: 100px; border: solid 1px #00a2d4;">
        ...
        <div class="pagination pagination-centered">
            <ul>
                <?php if($pageNo > 1) { ?>
                    <li><a href="donate_person.php?pageNo=<?php echo $pageNo-1;?>">&laquo;</a></li>
                <?php } ?>
                <?php for( $i=0; $i < $pageTotal; $i++) { ?>
                    <li><a <?php if($pageNo==$i+1){ ?>class="active"<?php } ?> href="donate_person.php?pageNo=<?php echo $i+1;?>">
                            <?php echo $i+1; ?></a></li>
                <?php } ?>
                <?php if($pageNo < $pageTotal) { ?>
                    <li><a href="donate_person.php?pageNo=<?php echo $pageNo+1;?>">&raquo;</a></li>
                <?php } ?>
            </ul>
        </div>
