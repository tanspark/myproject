...
<script type="text/javascript">
    $(document).ready(function (){
        var sWidth = $("#mainslider ul li").width(); //获取焦点图的宽度（显示面积）
...
<section id="container">
    ...
    <div class="container">
        ...
        <!--特色项目-->
        <div class="row">
            <div class="span12 our-works"><h4>Featured Projects</h4></div>
            <div class="span12">
                ...
                <ul class="thumbnails">
                                    ...
                                    <li style="height: 35px; ">
                                            <span style="float: left;">
                                                <a href="news_list_detail.php?id=<?php echo $res_news[$i]['t_id'] ?>">
                                                    <?php echo substr_text($res_news[$i]['t_title'], 0,40) ?></a>
                                            </span>
                    ...
                    <li class="span4">
                        <div class="trends-text">
                            <h4>Industry News<a href="news_trends.php"><span style="float: right;">+</span></a></h4>
                            <hr>
                            <ul style="margin-left: -10px;">
                                    ...
                                    <li style="height: 35px; ">
                                            <span style="float: left;">
                                                <a href="news_trends_detail.php?id=<?php echo $res_trends[$i]['t_id'] ?>">
                                                    <?php echo substr_text($res_trends[$i]['t_title'], 0, 40) ?></a>
                                            </span>
                                        <span style="float: right;">[<?php echo date('m-d', strtotime($res_news[$i]['t_time'])); ?>]</span>
                                    </li>
                                <?php } ?>
                                    ...
                                    <li style="height: 35px; ">
                                            <span style="float: left;">
                                                <a href="news_story_detail.php?id=<?php echo $res_story[$i]['t_id'] ?>">
                                                    <?php echo substr_text($res_story[$i]['t_title'], 0,40) ?></a>
                                            </span>
                                        <span style="float: right;">[<?php echo date('m-d', strtotime($res_news[$i]['t_time'])); ?>]</span>
                                    </li>
                                <?php } ?>
        ...
        <div class="row">
            <div class="span12">
                <h4 style="font-weight: 600; padding-top: 10px;">Memorabilia</h4>
                                ...
                                <li>
                                    <a href="chronic_event.php?id=<?php echo $res_event[$i]['t_id'] ?>" >
                                        ...
                                        <div style="text-align: center;">
                                            <?php echo substr_text($res_event[$i]['t_title'], 0,40) ?>
                                        </div>
                                    </a>
                                </li>
                            <?php } ?>
        ...
        <div class="row">
            ...
            <div class="span12">
                ...
                <a href="javascript:;" id="leftArr" class="move-left"> <<< &nbsp; turn left</a>
                <a href="javascript:;" id="rightArr" class="move-right">turn right &nbsp; >>></a>
            </div>
