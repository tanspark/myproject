...
<section id="container">
    <div class="container">
        <div class="row">
            ...
            <section class="span10 portfolio filtrable clearfix">
                ...
                <article data-id="id-1" data-type="javascript html" class="span3">
                    <div class="inner-image" style="width: 300px; height:300px; border: solid 1px #00a2d4;">
        ...
        <div class="pagination pagination-centered">
            <ul>
                <?php if($pageNo > 1) { ?>
                <li><a href="info_annual.php?pageNo=<?php echo $pageNo-1;?>">&laquo;</a></li>
                <?php } ?>
                <?php for( $i=0; $i < $pageTotal; $i++) { ?>
                    <li><a <?php if($pageNo==$i+1){ ?>class="active"<?php } ?> href="info_annual.php?pageNo=<?php echo $i+1;?>">
                            <?php echo $i+1; ?></a></li>
                <?php } ?>
                <?php if($pageNo < $pageTotal) { ?>
                <li><a href="info_annual.php?pageNo=<?php echo $pageNo+1;?>">&raquo;</a></li>
                <?php } ?>
            </ul>
        </div>
