        ...
        <div class="row">
            ...
            <section id="page-sidebar" class="pull-right span10">
                ...
                <div class="pagination pagination-centered">
                    <ul>
                        <?php if($pageNo > 1) { ?>
                            <li><a href="info_report.php?pageNo=<?php echo $pageNo-1;?>">&laquo;</a></li>
                        <?php } ?>
                        <?php for( $i=0; $i < $pageTotal; $i++) { ?>
                            <li><a <?php if($pageNo==$i+1){ ?>class="active"<?php } ?> href="info_report.php?pageNo=<?php echo $i+1;?>">
                                    <?php echo $i+1; ?></a></li>
                        <?php } ?>
                        <?php if($pageNo < $pageTotal) { ?>
                            <li><a href="info_report.php?pageNo=<?php echo $pageNo+1;?>">&raquo;</a></li>
                        <?php } ?>
                    </ul>
                </div>
            </section>
