...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      twitter_url: "twitter.com_kp",               // [string]   custom twitter url, if any (apigee, etc.)
      twitter_api_url: "api.twitter.com_kp",       // [string]   custom twitter api url, if any (apigee, etc.)
      twitter_search_url: "search.twitter.com_kp", // [string]   custom twitter search url, if any (apigee, etc.)
      ...
      if (secure) {
        return ('user' in item) ?
          ...
          extract_avatar_url(item, false).
            replace(/^http:\/\/[a-z0-9]{1,3}\.twimg\.com\//, "https://s3.amazonaws.com_kp/twitter_production/");
      } else {
