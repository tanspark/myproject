...
$pageSize = 15;
$total = MySqlOperateMatch::getInstance()->totals('t_notice');
$pageTotal = (int)(($total % $pageSize == 0) ? ($total / $pageSize) : ($total / $pageSize + 1));
$res = MySqlOperateMatch::getInstance()->field('t_id,t_title,t_author,t_time')
        ...
        <div class="row">
            ...
            <section id="page-sidebar" class="pull-left span10">
                        ...
                        <div class="row">
                            <div class="span10">
                                ...
                                <div class="post-content" style="margin-top: 10px;">
                                    ...
                                    <a href="welfare_policy_detail.php?id=<?php echo $res[$i]['t_id']; ?>"><?php echo $res[$i]['t_title']; ?></a>
                ...
                <div class="pagination pagination-centered">
                    <ul>
                        <?php if($pageNo > 1) { ?>
                            <li><a href="welfare_policy.php?pageNo=<?php echo $pageNo-1;?>">&laquo;</a></li>
                        <?php } ?>
                        <?php for( $i=0; $i < $pageTotal; $i++) { ?>
                            <li><a <?php if($pageNo==$i+1){ ?>class="active"<?php } ?> href="welfare_policy.php?pageNo=<?php echo $i+1;?>">
                                    <?php echo $i+1; ?></a></li>
                        <?php } ?>
                        <?php if($pageNo < $pageTotal) { ?>
                            <li><a href="welfare_policy.php?pageNo=<?php echo $pageNo+1;?>">&raquo;</a></li>
                        <?php } ?>
                    </ul>
                </div>
                <?php } ?>
